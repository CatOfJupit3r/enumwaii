...
the repository's [private report form](https://github.com/CatOfJupit3r/enumwaii/security/advisories/new).
Clearly label the submission as a Code of Conduct report. All complaints will
be reviewed and investigated promptly and fairly, and the privacy and security
of the reporter will be respected.

## Enforcement guidelines

Maintainers will follow these Community Impact Guidelines when determining the
consequences for an action they deem in violation of this Code of Conduct.
...
no interaction with the people involved for a specified period. Violating these
...
the community for a specified period. Violating the terms may lead to a
permanent ban.

### 4. Permanent ban

**Community impact:** A pattern of violating community standards, harassment of
