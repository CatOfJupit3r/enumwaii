...
reservations.availability deliberately accepts and returns an enumwaii scalar Standard Schema. Request and transition procedures compose the same status into Zod contracts through `emToZodSchema`.
